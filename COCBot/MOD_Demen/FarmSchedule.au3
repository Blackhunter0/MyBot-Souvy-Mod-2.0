	...
	For $i = 0 To 7
		...
		If $g_abChkSetFarm[$i] Then
			...
			EndIf
 			...
 			If $g_bDebugSetlog = 1 Then Setlog($i + 1 & ". $iTimer1 = " & $iTimer1 & ", $iTimer2 = " & $iTimer2 & ", $iStartHour = " & $iStartHour & ", $iAction = " & $iAction, $COLOR_DEBUG)
			...
			If $iStartHour >= 0 And $iStartHour >= _Min($iTimer1, $iTimer2) Then
				...
				If $g_bDebugSetlog = 1 Then SetLog("   $iStartHour = " & $iStartHour & ", $iAction = " & $iAction, $COLOR_DEBUG)
			EndIf
