...
Global $aTabControlsStrategies, $aTabControlsBot, $aTabControlsStats, $aTabControlsBotSwitch ; GUI Tab for SwitchAcc & FarmSchedule - Demen_SA_#9001 & Demen_FS_#9012
...
Func InitializeControlVariables()
   ...
   $g_aGroupAttackDBSpell = $g_hChkDBLightSpell&"#"&$g_hChkDBHealSpell&"#"&$g_hChkDBRageSpell&"#"&$g_hChkDBJumpSpell&"#"&$g_hChkDBFreezeSpell&"#"&$g_hChkDBPoisonSpell&"#"& _
						 $g_hChkDBEarthquakeSpell&"#"&$g_hChkDBHasteSpell&"#"&$g_hChkDBSkeletonSpell&"#"&$g_hChkDBCloneSpell
   ...
   Dim $aTabControlsBotSwitch = [$g_hGUI_BOT_SWITCH_TAB, $g_hGUI_BOT_SWITCH_TAB_ITEM1, $g_hGUI_BOT_SWITCH_TAB_ITEM2] ; GUI Tab for SwitchAcc & FarmSchedule - Demen_SA_#9001 & Demen_FS_#9012
   Dim $aTabControlsStats = [$g_hGUI_STATS_TAB, $g_hGUI_STATS_TAB_ITEM1, $g_hGUI_STATS_TAB_ITEM2, $g_hGUI_STATS_TAB_ITEM3]
	...
	For $i in $aTabControlsBot
		$oAlwaysEnabledControls($i) = 1
	Next
	For $i in $aTabControlsBotSwitch ; GUI Tab for SwitchAcc & FarmSchedule - Demen_SA_#9001 & Demen_FS_#9012
		$oAlwaysEnabledControls($i) = 1
	Next
