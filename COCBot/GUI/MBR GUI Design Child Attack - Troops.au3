...
Func LoadTranslatedBrewSpellsOrderList()
	...
	Global $g_asSpellsOrderList = ["", _
			...
			GetTranslatedFileIni("MBR Global GUI Design Names Spells", "TxtShortSkeletonSpells", "Skeleton")]
...
;========== Adding GUI for SmartTrain - Demen_ST_#9002 ==============
	...
	GUICtrlCreateGroup("Smart Train (do not empty barracks)", $x - 5, $y, $g_iSizeWGrpTab3, 38)
		$x += 7
		$y += 16
			$g_hchkSmartTrain = GUICtrlCreateCheckbox("Double Train Army", $x, $y, -1, 15)
